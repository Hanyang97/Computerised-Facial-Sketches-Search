...
# Usage: `sbatch /data/ziz/not-backed-up/haliu/idad/zizcommands/run_tuned_dad_10dim.sh`
...
#NOTSBATCH --gres=gpu:GeForce_GTX_2080  # use 1 GPU
...
python3 location_finding.py \
    ...
    --ckpt-path ./vaelogs/VanillaVAE/version_2/checkpoints/epoch=81-step=39277.ckpt \
    --vaeconfig-path ./vaelogs/VanillaVAE/version_2/config.yaml 
