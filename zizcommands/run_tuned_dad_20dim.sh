...
# Usage: `sbatch /data/ziz/not-backed-up/haliu/idad/zizcommands/run_tuned_dad_20dim.sh`
...
python3 location_finding.py \
    ...
    --ckpt-path ./vaelogs/VanillaVAE/version_1/checkpoints/epoch=70-step=34008.ckpt \
    --vaeconfig-path ./vaelogs/VanillaVAE/version_1/config.yaml 
