...
# Usage: `sbatch /data/ziz/not-backed-up/haliu/idad/zizcommands/run_tuned_dad_5dim.sh`
...
python3 location_finding.py \
    ...
    --ckpt-path ./vaelogs/VanillaVAE/version_3/checkpoints/epoch=82-step=39756.ckpt \
    --vaeconfig-path ./vaelogs/VanillaVAE/version_3/config.yaml
